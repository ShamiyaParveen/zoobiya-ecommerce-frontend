...
const SignIn = () => {
  ...
  return (
    // FIX 1: Added style={{ height: '100vh' }} to force full screen height
    <div className="container-fluid signpageui" >
      
      {/* FIX 2: Added 'h-100' (Bootstrap class for height: 100%) and 'g-0' (remove gutters/spacing) */}
        ...
        <div className="col-lg-4 col-md-5 col-12 bg-white d-flex flex-column justify-content-center align-items-center p-4 shadow-lg">
          ...
          <div className="w-100 container" >
            ...
            <form>
              ...
              {/* Username Input */}
              <div className="mb-3">
                {/* <label className="form-label small fw-bold text-secondary mb-1">USERNAME / ID</label> */}
